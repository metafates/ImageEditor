...
public class Sepia extends Transformation {
    public Sepia(final int intensity) {
        super((Consumer<BufferedImage>) image -> sepiaTransformation(image, intensity));
    }
     ...
     */
    private static void sepiaTransformation(final BufferedImage image, int sepiaIntensity) {
